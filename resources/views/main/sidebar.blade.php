<div class="ui sidebar vertical left menu overlay visible" style="-webkit-transition-duration: 0.1s; overflow: visible !important;">
    <div class="item logo">
      <img src="/image/rathore.png" /><img src="https://static-00.iconduck.com/assets.00/semantic-ui-icon-2048x2048-dtumoayv.png" style="display: none" />
    </div>
    <div class="ui accordion">
      ...
      <div class="content">
        <a class="item" href="user/create">Add User
        </a>
        <a class="item" href="/show-user">Show User
        </a>
